...
YY_RULE(int) yy_TOKEN_JAMO(yycontext *yy); /* 7 */
YY_RULE(int) yy_SP(yycontext *yy); /* 6 */
YY_RULE(int) yy_TOKEN_HANGUL(yycontext *yy); /* 5 */
YY_RULE(int) yy_SET(yycontext *yy); /* 4 */
YY_RULE(int) yy_TITLE(yycontext *yy); /* 3 */
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "TOKEN_JAMO"));  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\376\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\017\000\000\000")) goto l4;
  l5:;	
  {  int yypos6= yy->__pos, yythunkpos6= yy->__thunkpos;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\376\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\377\017\000\000\000")) goto l6;  goto l5;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "SP"));  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\001\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l7;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "TOKEN_HANGUL"));  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\377\377\377\377\377\377\377\377\377\377\377\377\377\077\000\000")) goto l8;
  l9:;	
  {  int yypos10= yy->__pos, yythunkpos10= yy->__thunkpos;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\377\377\377\377\377\377\377\377\377\377\377\377\377\077\000\000")) goto l10;  goto l9;
...
#undef yytext
#undef yyleng
  }  if (!yy_TOKEN_HANGUL(yy)) goto l11;  yyDo(yy, yySet, -4, 0);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_END)) goto l11;
#undef yytext
#undef yyleng
  }  if (!yy_SP(yy)) goto l11;  yyDo(yy, yy_1_SET, yy->__begin, yy->__end);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_BEGIN)) goto l11;
#undef yytext
#undef yyleng
  }  if (!yy_TOKEN_JAMO(yy)) goto l11;  yyDo(yy, yySet, -3, 0);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_END)) goto l11;
#undef yytext
#undef yyleng
  }  if (!yy_SP(yy)) goto l11;  yyDo(yy, yy_2_SET, yy->__begin, yy->__end);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_BEGIN)) goto l11;
#undef yytext
#undef yyleng
  }  if (!yy_TOKEN_JAMO(yy)) goto l11;  yyDo(yy, yySet, -2, 0);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_END)) goto l11;
#undef yytext
#undef yyleng
  }  if (!yy_SP(yy)) goto l11;  yyDo(yy, yy_3_SET, yy->__begin, yy->__end);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_BEGIN)) goto l11;
#undef yytext
#undef yyleng
  }  if (!yy_TOKEN_JAMO(yy)) goto l11;  yyDo(yy, yySet, -1, 0);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_END)) goto l11;
#undef yytext
#undef yyleng
  }  if (!yy_SP(yy)) goto l11;  if (!yy_EOL(yy)) goto l11;  yyDo(yy, yy_4_SET, yy->__begin, yy->__end);
...
#undef yytext
#undef yyleng
  }  if (!yy_TOKEN_HANGUL(yy)) goto l12;  yyDo(yy, yySet, -3, 0);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_END)) goto l12;
#undef yytext
#undef yyleng
  }  if (!yy_SP(yy)) goto l12;  yyDo(yy, yy_1_TITLE, yy->__begin, yy->__end);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_BEGIN)) goto l12;
#undef yytext
#undef yyleng
  }  if (!yy_TOKEN_JAMO(yy)) goto l12;  yyDo(yy, yySet, -2, 0);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_END)) goto l12;
#undef yytext
#undef yyleng
  }  if (!yy_SP(yy)) goto l12;  yyDo(yy, yy_2_TITLE, yy->__begin, yy->__end);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_BEGIN)) goto l12;
#undef yytext
#undef yyleng
  }  if (!yy_TOKEN_JAMO(yy)) goto l12;  yyDo(yy, yySet, -1, 0);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_END)) goto l12;
#undef yytext
#undef yyleng
  }  if (!yy_SP(yy)) goto l12;  if (!yy_EOL(yy)) goto l12;  yyDo(yy, yy_3_TITLE, yy->__begin, yy->__end);
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "STRUCT"));
  {  int yypos14= yy->__pos, yythunkpos14= yy->__thunkpos;  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_BEGIN)) goto l15;
#undef yytext
#undef yyleng
  }  if (!yy_TITLE(yy)) goto l15;  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_END)) goto l15;
#undef yytext
#undef yyleng
  }  yyDo(yy, yy_1_STRUCT, yy->__begin, yy->__end);  goto l14;
  l15:;	  yy->__pos= yypos14; yy->__thunkpos= yythunkpos14;  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_BEGIN)) goto l13;
#undef yytext
#undef yyleng
  }  if (!yy_SET(yy)) goto l13;  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_END)) goto l13;
#undef yytext
#undef yyleng
  }  yyDo(yy, yy_2_STRUCT, yy->__begin, yy->__end);
  }
  l14:;	
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "START"));
  {  int yypos17= yy->__pos, yythunkpos17= yy->__thunkpos;  if (!yy_STRUCT(yy)) goto l18;
  l19:;	
  {  int yypos20= yy->__pos, yythunkpos20= yy->__thunkpos;  if (!yy_STRUCT(yy)) goto l20;  goto l19;
  l20:;	  yy->__pos= yypos20; yy->__thunkpos= yythunkpos20;
  }  goto l17;
  l18:;	  yy->__pos= yypos17; yy->__thunkpos= yythunkpos17;  if (!yy_TITLE(yy)) goto l21;  goto l17;
  l21:;	  yy->__pos= yypos17; yy->__thunkpos= yythunkpos17;  if (!yy_SET(yy)) goto l16;
  }
  l17:;	
